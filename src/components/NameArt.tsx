import './lettercrap.css';
export default function NameArt(img_src: string) {
    const charWidth:number = 6;
	const charHeight:number = 10;
    ...
    function getTextContentWithImageAtSize(image: CanvasImageSource, width: number, height: number, existingText: string, words: string | any[], letters: any) {
